        ...
        <div className='FilterPanelContainer'>
            ...
            <div className='FilterSection'>
                ...
                <div className="FilterBox">
                    <input name="FilterCheckbox" className='FilterCheckbox' id="0" type='checkbox' onChange={() => { handleCategory("gardening") }} />
                    <label> Gardening </label>
                </div>
                <div className="FilterBox">
                    <input name="FilterCheckbox" className='FilterCheckbox' id="1" type='checkbox' onChange={() => { handleCategory("domestic cleaning") }} />
                    <label> Domestic cleaning </label>
                </div>
                <div className="FilterBox">
                    <input name="FilterCheckbox" className='FilterCheckbox' id="2" type='checkbox' onChange={() => { handleCategory("dog walking") }} />
                    <label> Dog walking </label>
                </div>
                <div className="FilterBox">
                    <input name="FilterCheckbox" className='FilterCheckbox' id="3" type='checkbox' onChange={() => { handleCategory("grocery shopping") }} />
                    <label> Grocery shopping </label>
                </div>
                <div className="FilterBox">
                    <input name="FilterCheckbox" className='FilterCheckbox' id="4" type='checkbox' onChange={() => { handleCategory("other") }} />
                    <label> Other </label>
                </div>
            </div>
            <div className='FilterSection'>
                ...
                <div className="DistanceSlider">
                    <input className='DistanceFilter' id='DistanceFilter' type='range'
                        min="0" max="50" steps="1" defaultValue="5" onChange={(e) => setDistance(e.target.value)} />
